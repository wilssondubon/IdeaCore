...
namespace GICoreUtils.Accessor
{
    ...
    public class ObjectAccesor
    {
        ...
        public ObjectAccesor(object pComponent) => this.Component = pComponent;
        /// <summary>
        /// obtiene el valor de una propiedad
        /// </summary>
        /// <param name="PropertyName">nombre de la propiedad</param>
        /// <returns>valor de la propiedad</returns>
        public object Get(string PropertyName) => new PropertyAccessor(this.Component.GetType(), PropertyName).GetValue(this.Component);
        /// <summary>
        /// define un nuevo valor para una propiedad
        /// </summary>
        /// <param name="PropertyName">nombre de la propiedad</param>
        /// <param name="value">nuevo valor a definir</param>
        public void Set(string PropertyName, object value) => new PropertyAccessor(this.Component.GetType(), PropertyName).SetValue(this.Component, value);
    }
}
